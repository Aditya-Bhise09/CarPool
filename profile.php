            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                ...
                <div class="d-flex">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li>
                            <a href="/CarPool/profile.php" class="text-decoration-none text-capitalize text-muted fw-bold m-3">
                                <?php echo $username; ?>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/CarPool/index.php?logout=1" class="btn btn-primary btn-md mx-3" >Logout</a>
