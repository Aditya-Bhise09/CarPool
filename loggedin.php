...
<head>
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com">
    ...
    <!-- <script src="https://apis.mapmyindia.com/advancedmaps/v1/otmgejldtrarevfpxptrfrtpmlokoixbnvgn/map_load?v=1.5"></script> -->
    <!-- <script src="https://apis.mapmyindia.com/advancedmaps/api/otmgejldtrarevfpxptrfrtpmlokoixbnvgn/map_sdk_plugins"></script> -->
    <!-- <script src="https://apis.mappls.com/advancedmaps/api/otmgejldtrarevfpxptrfrtpmlokoixbnvgn/map_sdk?v=3.0&layer=vector"></script> -->
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/CarPool/profile.php">My Profile</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-flex">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li>
                            <a href="/CarPool/profile.php" class="text-decoration-none text-capitalize text-muted fw-bold mx-3">
                                <?php echo $username ?>
                            </a>
                        </li>
                        <li>
                            <a href="/CarPool/profile.php">
                            <?php 
                                if(empty($picture))
                                {
  ...
  <form method="post" id="edittripform">  
    ...
    <footer class="bg-light text-center text-lg-start mt-auto mb-0 " id="footer" >
        ...
        <div class="text-center p-3 footer " >
            <p>CarPool Innovations Copyright &copy; 2025-<?php $today=date("Y"); echo $today;  ?>.
            </p>
        </div>
    </footer>
  <!-- Spinner -->
