...
$departureLatitude = isset($_POST['departureLatitude']) ? $_POST['departureLatitude'] : 0;
$departureLongitude = isset($_POST['departureLongitude']) ? $_POST['departureLongitude'] : 0;
$destinationLatitude = isset($_POST['destinationLatitude']) ? $_POST['destinationLatitude'] : 0;
$destinationLongitude = isset($_POST['destinationLongitude']) ? $_POST['destinationLongitude'] : 0;
