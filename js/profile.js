...
$("#updateusernameform").submit(function(event){
    ...
    $.ajax({
        url:"/CarPool/lib/updateusername.php",
        type: "POST",
        data: datatopost,
...
$("#updateemailform").submit(function(event){
    ...
    //send data to php file using AJAX
    $.ajax({
        url:"/CarPool/lib/updateemail.php",
        type: "POST",
        data: datatopost,
        success: function(data){
            if(data)
...
//Ajax Call for update password form
//Once the form is submitted
$("#updatepasswordform").submit(function(event){
    ...
    //send data to php file using AJAX
    $.ajax({
        url:"/CarPool/lib/updatepassword.php",
        type: "POST",
        data: datatopost,
        success: function(data){
            if(data)
...
$("#updatepictureform").submit(function(event){
    ...
    //send data to php file using AJAX
    $.ajax({
        url:"/CarPool/lib/updatepicture.php",
        type: "POST",
