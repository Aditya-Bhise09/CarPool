...
if($results){
    echo '<div class="alert alert-danger">That email is already registered. Please log in?</div>'; 
}
...
$message .= "http://localhost:8080/CarPool/lib/activate.php?email=" . urlencode($email) . "&key=$activationKey";
...
try {
    ...
    //Recipients
    $mail->setFrom(MYEMAIL, 'Carpool Innovations');
