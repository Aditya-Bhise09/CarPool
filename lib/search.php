...
(departureLongitude = '$departureLongitude' AND departureLatitude = '$departureLatitude')  
AND (destinationLongitude='$destinationLongitude' AND destinationLatitude='$destinationLatitude')";
